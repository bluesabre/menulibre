...
files.append('%s/share/icons/hicolor/scalable/apps/menulibre.svg' % target)
for size in ['16x16', '24x24', '32x32', '48x48', '64x64']:
    files.append(
        '%s/share/icons/hicolor/%s/apps/menulibre.png' %
        (target, size))
