        ...
        try:
            ...
            if name.startswith("applications-"):
                try:
                    ...
                    pixbuf = GdkPixbuf.new_from_file_at_size("../data/icons/applications-other.svg", width, height)
            else:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            pixbuf = GdkPixbuf.new_from_file_at_size("../data/icons/image-missing.svg", width, height)
